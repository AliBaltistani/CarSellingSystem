...
<head>
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="{{ $seo['title'] ?? $globalSettings['meta_title'] ?? $globalSettings['site_name'] ?? config('app.name') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-400 mb-4">
                        {{ $globalSettings['site_description'] ?? 'Your trusted platform for buying and selling quality cars. Find your perfect vehicle today.' }}
                    </p>
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ $linkedin }}" target="_blank" class="text-slate-400 hover:text-white transition-colors">
