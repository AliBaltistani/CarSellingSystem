        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <form action="{{ $partner->exists ? route('admin.financing-partners.update', $partner) : route('admin.financing-partners.store') }}" 
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="2" placeholder="Brief description (optional)"
                        class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent">{{ old('description', $partner->description) }}</textarea>
                </div>
