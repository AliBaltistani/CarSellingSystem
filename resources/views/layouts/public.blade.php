...
<head>
    ...
    <title>{{ $seo['title'] ?? $globalSettings['meta_title'] ?? $globalSettings['site_name'] ?? config('app.name') }}</title>
    <meta name="description" content="{{ $seo['description'] ?? $globalSettings['meta_description'] ?? '' }}">
    <meta name="keywords" content="{{ $seo['keywords'] ?? $globalSettings['meta_keywords'] ?? '' }}">
    
    <!-- Open Graph -->
    <meta property="og:title" content="{{ $seo['title'] ?? $globalSettings['meta_title'] ?? config('app.name') }}">
    <meta property="og:description" content="{{ $seo['description'] ?? $globalSettings['meta_description'] ?? '' }}">
    <meta property="og:image" content="{{ $seo['og_image'] ?? ($globalSettings['site_logo'] ? Storage::url($globalSettings['site_logo']) : asset('images/og-default.jpg')) }}">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <p class="text-slate-500 max-w-md">
                        {{ $globalSettings['site_description'] ?? 'Your trusted marketplace for buying and selling quality cars.' }}
                    </p>
                    <div class="flex space-x-4 mt-6">
                        @if(!empty($globalSettings['facebook_url']))
                        <a href="{{ $globalSettings['facebook_url'] }}" class="w-10 h-10 bg-slate-800 hover:bg-slate-700 rounded-lg flex items-center justify-center transition-colors">
                        ...
                        <a href="{{ $globalSettings['instagram_url'] }}" class="w-10 h-10 bg-slate-800 hover:bg-slate-700 rounded-lg flex items-center justify-center transition-colors">
                        ...
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $globalSettings['whatsapp_number']) }}" class="w-10 h-10 bg-slate-800 hover:bg-slate-700 rounded-lg flex items-center justify-center transition-colors">
            ...
            <div class="border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
                <p class="text-slate-500 text-sm">
                    &copy; {{ date('Y') }} {{ $globalSettings['site_name'] ?? '' }}. All rights reserved.
                </p>
