...
<head>
    ...
    <title>Confirm Password - {{ $globalSettings['site_name'] ?? config('app.name', 'CarSellingSystem') }}</title>

    <link rel="preconnect" href="https://fonts.bunny.net">
    <link href="https://fonts.bunny.net/css?family=inter:400,500,600,700&display=swap" rel="stylesheet" />
    <meta name="description" content="{{ $globalSettings['meta_description'] ?? 'Confirm your password' }}">
    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center px-12 lg:px-16 xl:px-24">
                ...
                <div class="w-20 h-20 bg-gradient-to-br from-blue-400/20 to-indigo-500/20 rounded-3xl flex items-center justify-center mb-8">
                ...
                <h1 class="text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
                    Security<br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500">Checkpoint</span>
                </h1>

                <p class="text-slate-400 text-lg mb-8 max-w-md">
                    For your protection, please confirm your password before accessing this secure area of the application.
                </p>
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-3 text-slate-300">
                        ...
                        <span>Protects sensitive operations</span>
                    </div>
                    <div class="flex items-center space-x-3 text-slate-300">
                        <div class="w-8 h-8 bg-blue-500/20 rounded-lg flex items-center justify-center">
                            <svg class="w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span>Ensures account ownership</span>
                    </div>
                    <div class="flex items-center space-x-3 text-slate-300">
                        <div class="w-8 h-8 bg-blue-500/20 rounded-lg flex items-center justify-center">
                            <svg class="w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span>Your data stays safe & encrypted</span>
                    </div>
                </div>
            </div>

            <div class="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-br from-blue-500/10 to-indigo-500/10 rounded-full blur-3xl"></div>
            <div class="absolute top-20 right-20 w-64 h-64 bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-full blur-3xl"></div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center px-6 sm:px-12 lg:px-16 xl:px-24 bg-white">
            <div class="max-w-md w-full mx-auto">
                ...
                <div class="w-16 h-16 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl flex items-center justify-center mb-6 border border-blue-100">
                ...
                <p class="text-slate-500 mb-8">This is a secure area. Please confirm your password before continuing.</p>
