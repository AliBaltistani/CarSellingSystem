...
<head>
    ...
    <title>Reset Password - {{ $globalSettings['site_name'] ?? config('app.name', 'CarSellingSystem') }}</title>
    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center px-12 lg:px-16 xl:px-24">
                ...
                <div class="w-20 h-20 bg-gradient-to-br from-emerald-400/20 to-teal-500/20 rounded-3xl flex items-center justify-center mb-8">
                ...
                <h1 class="text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
                    Create Your<br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-teal-500">New Password</span>
                </h1>

                <p class="text-slate-400 text-lg mb-8 max-w-md">
                    Choose a strong, unique password to keep your account secure. We recommend using a mix of letters, numbers, and symbols.
                </p>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center space-x-3 text-slate-300">
                        ...
                        <span>Mix of upper & lowercase letters</span>
                    </div>
                    <div class="flex items-center space-x-3 text-slate-300">
                        <div class="w-8 h-8 bg-emerald-500/20 rounded-lg flex items-center justify-center">
                            <svg class="w-4 h-4 text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 rounded-full blur-3xl"></div>
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center px-6 sm:px-12 lg:px-16 xl:px-24 bg-white">
            <div class="max-w-md w-full mx-auto">
                ...
                <div class="w-16 h-16 bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl flex items-center justify-center mb-6 border border-emerald-100">
                ...
                <p class="text-slate-500 mb-8">Enter your new password below</p>
                ...
                <p class="text-center mt-8">
                    <a href="{{ route('login') }}" class="text-sm text-slate-500 hover:text-amber-600 transition-colors">
                        ← Back to Sign In
                    </a>
                </p>
            </div>
